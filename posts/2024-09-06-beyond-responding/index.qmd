...
open-graph:
  title: "Beyond Responding"
  description: "Using behaviours as meaning"
  image: https://www.lumosinsight.co.uk/posts/2024-09-06-beyond-responding/On_meanings_as_substantive_evidence_the_patent_office__c05cc99c-45a0-474b-b75e-835d108a8892.png
twitter-card:
...
The key concern here is evidence—observations that can support these claims. Think of them as theoretical tent pegs: "People who did this were also more likely to do that" and so on. Note that some people think this is not entirely justified as an endeavour[^1].

[^1]: Sydney University professor [Joel Michell](https://scholar.google.com/citations?user=ei0Gh7cAAAAJ&hl=en) has a fair bit to say on the extent to which psychological constructs can be quantified in a way that is mathematically relevant and justifiable.
